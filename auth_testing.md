...
curl -X POST "https://your-app.com/api/invoices" \
  -H "Content-Type: application/json" \
  -H "Authorization: Bearer YOUR_SESSION_TOKEN" \
  -d '{"document_type": "Invoice", "customer_name": "Test Customer", "invoice_date": "2025-12-20", "items": [{"description": "Test Item", "quantity": 1, "rate": 100, "amount": 100}], "tax_rate": 20}'
```
